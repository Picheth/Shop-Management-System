                        ...
                        0 ? (
                            filteredPurchaseOrders.map(
                                po => (
                                    ...
                                    >
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-sky-600 dark:text-sky-400">
                                            {
                                                po.id
                                            }
                                        </td>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-right text-gray-700 dark:text-gray-200 font-medium">
                                            $
                                            {(
                                                po.total ||
                                                0
